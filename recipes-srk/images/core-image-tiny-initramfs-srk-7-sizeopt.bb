SUMMARY = "srk-7-sizeopt: BusyBox-only initramfs with global size CFLAGS/LDFLAGS + lz4"
DESCRIPTION = "Derived from srk-6; evaluates impact of -Os, section GC, and lz4 compression on minimal BusyBox musl initramfs."
LICENSE = "MIT"
...
python create_simple_init () {
    ...
    script = "#!/bin/sh\n\nmount -t proc proc /proc 2>/dev/null || true\nmount -t sysfs sysfs /sys 2>/dev/null || true\necho 'Initramfs (srk-7-sizeopt) shell. Size flags enabled. Press Ctrl-D to reboot.'\nexec /bin/sh\n"
